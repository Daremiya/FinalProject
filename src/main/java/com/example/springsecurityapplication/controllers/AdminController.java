...
public class AdminController {
   ...
   @GetMapping("admin/product/add")
    ...
    public String editProduct(@ModelAttribute("product")
        ...
        if (!file_one.isEmpty() && file_one.getSize() >0) {
            File uploadDir = new File(uploadPath);
            if (!uploadDir.exists()) {
                uploadDir.mkdir();
            }
        ...
        if (!file_two.isEmpty() && file_two.getSize() >0) {
            File uploadDir = new File(uploadPath);
            if (!uploadDir.exists()) {
                uploadDir.mkdir();
            }
        ...
        if (!file_three.isEmpty() && file_three.getSize() >0) {
            File uploadDir = new File(uploadPath);
            if (!uploadDir.exists()) {
                uploadDir.mkdir();
            }
        ...
        if (!file_four.isEmpty() && file_four.getSize() >0) {
            File uploadDir = new File(uploadPath);
            if (!uploadDir.exists()) {
                uploadDir.mkdir();
            }
        ...
        if (!file_five.isEmpty() && file_five.getSize() >0) {
            File uploadDir = new File(uploadPath);
            if (!uploadDir.exists()) {
                uploadDir.mkdir();
            }
